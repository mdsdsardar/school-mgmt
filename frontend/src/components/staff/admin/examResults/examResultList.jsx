...
const ExamResultList = () => {
  ...
  const { loading, error, allExamResult, examResultCount, isDeleted } =
  ...
  useEffect(() => {
    ...
    dispatch(allExamResults({ limit, currentPage, name: searchQuery }));
    ...
    if (isDeleted) {
      ...
      navigate("/student/all/exam-result");
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <Fragment>
            <Link
              to={`/admin/exam-result/${params.row.id}`}
  ...
  return (
    <Fragment>
      <MetaData title={"All Exam Result"} />
      <div className="row">
        ...
        <div className="col-12 col-md-10">
          <Fragment>
            <h1 className="my-5">All Exam Result</h1>
            {loading ? (
              <Loader />
            ) : (
              <div style={{ width: "100%" }}>
                ...
                <div style={{ height: 400, width: "100%" }}>
                  ...
                  allExamResult.length === 0 ? (
                    ...
                    >
                      <h1 className="mt-5">All Exam Result</h1>
