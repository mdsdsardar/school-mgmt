...
const AdminLogin = () => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(getAuth({ formData, url: "admins" }));
  };
  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <Fragment>
          <MetaData title={"Login as Admin"} />
          <div className="row wrapper">
            <div className="col-10 col-lg-5">
              <form className="shadow-lg" onSubmit={submitHandler}>
                <h1 className="mb-3">Login as Admin</h1>
                ...
                <div className="text-center">
                  <Link to="/teacher/login" className="d-block py-2">
                    <i className="fa fa-user"></i> Login As Teacher?
                  </Link>
